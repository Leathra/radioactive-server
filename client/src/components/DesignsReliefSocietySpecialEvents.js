...
const DesignsReliefSocietySpecialEvents = () => {
  return (
    <div>
      <div className="row">
      ...
      <div className="container">
        <div className="center-align col s12">
          <Link className="breadcrumb teal-text base"
            ...
            <Link className="breadcrumb teal-text base"
              to={'./DesignsReliefSociety'}>Relief Society</Link><i className="tiny material-icons teal-text base">arrow_forward</i>
              <Link className="breadcrumb teal-text base"
                to={'./DesignsReliefSocietySpecialEvents'}>Special Events</Link>
        </div>
...
export default DesignsReliefSocietySpecialEvents;
