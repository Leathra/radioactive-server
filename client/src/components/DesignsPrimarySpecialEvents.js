...
const DesignsPrimarySpecialEvents = () => {
  return (
    <div>
      <div className="row">
      ...
      <div className="container">
        <div className="center-align col s12">
          <Link className="breadcrumb teal-text base"
            ...
            <Link className="breadcrumb teal-text base"
              to={'./DesignsPrimary'}>Primary</Link><i className="tiny material-icons teal-text base">arrow_forward</i>
              <Link className="breadcrumb teal-text base"
                to={'./DesignsPrimarySpecialEvents'}>Primary Special Events</Link>
        </div>
        ...
        <div className="row">
          ...
          <div className="col s12 m4">
            <div className="card hoverable">
              <Link to={'./ProductPageEightAplique'}>
              <div className="card-image"
              style={{ border: "2px solid #ffd180"}}>
                <img alt="image not available" className="reponsive-img"
                src={window.location.origin + '/assets/eightAplique.jpg'}/>
              </div>
              <div className="card-content">
                <div className="row">
                  <div className="col s9">
          ...
          <div className="col s12 m4">
            <div className="card hoverable">
              <Link to={'./ProductPageEightLettering'}>
              <div className="card-image"
              style={{ border: "2px solid #ffd180"}}>
                <img alt="image not available" className="reponsive-img"
...
export default DesignsPrimarySpecialEvents;
