    ...
    <div>
      ...
      <div className="center-align col s12">
        <Link className="breadcrumb teal-text base"
          ...
          <Link className="breadcrumb teal-text base"
            to={'./DesignsReliefSociety'}>Relief Society</Link>
      </div>
            ...
            <div className="col s12 m6">
              <div className="card-panel small">
                <div style={{ maxWidth: '100%',
                        maxHeight: '100%'}}>
                    <span className="card-title center-align teal-text text-lighten-2">Enrichment Activities</span>
                  </div>
                  <div style={{ marginTop: '20px',
                                marginBottom: '40px'}}>
                    <Link className="waves-effect waves-light btn orange darken-2 hoverable"
                      to={'./DesignsEnrichmentActivities'}
                      >
                       Shop the Collection
                      </Link>
                    </div>
          ...
          <div className="col s12 m6">
            <div className="card-panel small">
              ...
              <div style={{ marginTop: '20px',
                            marginBottom: '40px'}}>
                <Link className="waves-effect waves-light btn orange darken-2 hoverable"
                  to={'./DesignsReliefSocietySundays'}
                  >
                   Shop the Collection
                  </Link>
                </div>
          ...
          <div className="col s12 m6">
            <div className="card-panel small">
              ...
              <div style={{ marginTop: '20px',
                            marginBottom: '40px'}}>
                <Link className="waves-effect waves-light btn orange darken-2 hoverable"
                  to={'./DesignsReliefSocietySpecialEvents'}
                  >
                   Shop the Collection
                  </Link>
                </div>
...
export default DesignsReliefSociety;
